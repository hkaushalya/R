#random exercise to learn geographical MAP using
#http://www.r-bloggers.com/maps-in-r-choropleth-maps/

rm(list=ls())
setwd("/Users/samantha/Documents/Personal/Samantha/LearningMaterials/IntroToR/RandomExercises")
...
eurMapDf <- readShapePoly(fn="./data/NUTS_2010_60M_SH/data/NUTS_RG_60M_2010")


# read downloaded data (change folder appropriately)
eurEdu <- read.csv("./data/educ_thexp_1_Data.csv", stringsAsFactors = F)
